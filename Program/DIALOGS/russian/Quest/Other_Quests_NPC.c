void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "RatOfficer_5":
			...
			link.l1 = "Да, ты прав, черт возьми! Все из-за них, богоотступников. Эх, и как это одно"+ GetSexPhrase("му","й") +" от Тортуги до Белиза добраться? А ведь ещё по пути в залив Гибели зайти надо - хозяин велел с индейцами тамошними сделку провести - камушков драгоценных у них за бесценок прикупить, да и запасы воды пресной пополнить... Слушай, а ты часом не в том направлении курс держишь? Может...";
		...
		case "Halen_3":
			dialog.text = "Удовлетворён"+ GetSexPhrase("","а") +" знакомством? А теперь – убирайся к дьяволу и прекрати мозолить глаза, деревенщина!";
			link.l1 = "Гхм...";
