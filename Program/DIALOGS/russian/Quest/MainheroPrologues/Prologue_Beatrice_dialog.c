void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			dialog.text = "Так это ты тот вор, что увёл у меня карту.";
		...
		case "2":
			dialog.text = "Ну конечно. Она просто валялась на дороге, а ты её подобрал. И другую половину тоже, судя по тому, что ты сюда добрался. Так я и поверила.";
...
//grotto - dialog 2
		...
		case "7":
			...
			link.l1.go = "8";
			link.l2 = "Твой брат. Боюсь, теперь мне придётся тебя убить - я не имею никакого желания делиться моими сокровищами с кем-либо кроме меня, и, опять же, меня. Пора заканчивать нашу семейную встречу.";
		...
		case "9":
			...
			link.l1 = "Либертания, говоришь... Большая мечта, это уж точно. Интересно, приблизился ли он к её воплощению? Кроме того, что собрал здоровенную кучу денег, конечно.";
			link.l1.go = "10";
...
//at pirate meeting
		...
		case "22":
			dialog.text = "Вы сомневаетесь в Блэйзе, в том, что его мечты реальны. Я скажу вам - если в этой комнате и есть кто-то, кто способен воплощать мечты, то это он. Вы колеблетесь. Я могу вас понять - такие решения нелегко даются. Но подумайте вот о чем: шанс изменить мир - чертовски редкая штука. Очень немногие вообще когда-либо получают такой шанс, и никто, никогда не получает его дважды. Все это, здесь и сейчас - это наш шанс. Что с ним делать - решать вам и только вам. Но я знаю одно - я не упущу свой шанс даже за все золото мира! Я сделала свой выбор, теперь ваш черёд!";
			link.l1 = "...";
			link.l1.go = "Exit";
		break;
