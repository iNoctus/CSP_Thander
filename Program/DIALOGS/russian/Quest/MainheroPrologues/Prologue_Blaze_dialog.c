void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "2":
			dialog.text = "Ну конечно. Она просто валялась на дороге, а ты её подобрала. И другую половину тоже, судя по тому, что ты сюда добралась. Так я и поверил.";
...
//grotto - dialog 2
		...
		case "6":
			dialog.text = "Хорошо, я отвечу. Не так давно я встретил странного человека, который дал мне половину этой чёртовой карты, объяснив, что обещал моему отцу это сделать. Однажны утром вскоре после этого кто-то стащил у меня карту, пока я боролся с похмельем в какой-то паршивой таверне. Я весьма настойчиво порасспросил местных, и наконец нашёл человека, который рассказал, что видел, как ты разговаривала с трактирщиком и размахивала чем-то весьма напоминающим обрывок карты. Я подумал, что это ты украла мою карту, и что теперь ты ищешь вторую половину. Так что я решил позволить тебе её найти и проследить, куда она тебя приведет.";
			link.l1 = "Ловко. Но ты ошибся в одном - хотя я действительно искала вторую половину карты, это была, насколько я понимаю, твоя половина. Мою я к тому времени уже получила, причём таким же образом, как и ты - свою. Твою половину я на самом деле купила у того трактирщика, за совершенно сумасшедшие деньги, кстати. Напомни мне от души поблагодарить его за продажу краденого товара без скидки.";
			link.l1.go = "7";
		break;
		...
		case "7":
			...
			link.l1.go = "8";
			link.l2 = "Твоя сестра. Боюсь, теперь мне придётся тебя убить - я не имею никакого желания делиться моими сокровищами с кем-либо кроме меня, и, опять же, меня. Пора заканчивать нашу семейную встречу.";
		...
		case "9":
			dialog.text = "Не знаю, может и он и хотел... Но я знаю, зачем он сам собирал это богатство. Понимаешь, тот человек, что передал мне мою половину карты, дал мне ещё и отцовский дневник. Похоже, у отца была мечта - создать на Карибах новое государство, свободное от мелочных войн и жадных губернаторов Старого Света, способное построить лучшее будущее для своих граждан. Он называл его Либертанией. Эти деньги предназначались для его создания.";
			link.l1 = "Либертания, говоришь... Красивая мечта. Интересно, приблизился ли он к её воплощению? Кроме того, что собрал здоровенную кучу денег, конечно.";
			link.l1.go = "10";
			link.l2 = "Эти деньги, как и все остальные в этом мире, предназначены моему кошельку. Все, кто считает иначе или убираются с моей дороги, или умирают. Поскольку ты вряд ли уберёшься с дороги, придётся тебя убить.";
			link.l2.go = "Exit kill";
		break;

		case "10":
			dialog.text = "Не просто приблизился, а почти что воплотил, но его враги сделали все, чтобы люди об этом забыли. 20 лет назад он собрал мощный флот, чтобы захватить колонии, но один из его людей предал все его планы врагам. Флот отца был перехвачен объединёнными силами Англии, Франции и Голландии, и уничтожен в тяжёлом бою. Наш отец погиб в том бою, и колониальные державы приложили большие усилия к тому, чтобы показать его простым пиратом, которого настигло справедливое возмездие. Но он, похоже, предусмотрел это, и устроил так, чтобы мы с тобой росли в безопасности, вдали друг от друга, и унаследовали его сокровище и мечты, когда мы вырастем, а его дела будут благополучно забыты.";
		...
		case "11":
			...
			link.l2 = "Ты же не надеешься всерьёз вот просто так взять и выкинуть колониальные власти с архипелага, со всеми их деньгами, кораблями и влиянием? Нет, в этом сумасшествии я не желаю принимать никакого участия. Транжирь свою половину сокровищ как тебе вздумается, а я заберу свою.";
...
//grotto - dialog 3
		...
		case "13":
			dialog.text = "Честно говоря, понятия не имею... Но у меня есть на примете кое-кто сведущий в этом деле. В своём дневнике отец часто упоминает некоего Роберта Стаффордшира - он, похоже, был главным советником отца в том, что касалось государственных дел. Я навёл о нем справки - оказывается, он до сих пор в добром здравии, и живёт на Исла Моне. Я не знаю, поможет ли он нам, но это наш лучший шанс. Я думаю, нам стоит с ним встретиться.";
			link.l1 = "Согласна. Если он помогал отцу, возможно, поможет и нам.";
			link.l1.go = "14";
		break;

		case "14":
			dialog.text = "Тогда я отправлюсь вперёд и договорюсь о встрече. Мы будем ждать тебя в таверне Исла Моны.";
...
//after advisor quest done
		...
		case "17":
			dialog.text = "Тогда я начну готовиться к отплытию прямо сейчас. Нам ещё многое нужно сделать. Я вернусь недели через две, но возможны задержки.";
...
//at pirate meeting
		...
		case "22":
			dialog.text = "Вы сомневаетесь в Беатрис, в том, что её мечты реальны. Я скажу вам - если в этой комнате и есть кто-то, кто способен воплощать мечты, то это она. Вы колеблетесь. Я могу вас понять - такие решения нелегко даются. Но подумайте вот о чем: шанс изменить мир - чертовски редкая штука. Очень немногие вообще когда-либо получают такой шанс, и никто, никогда не получает его дважды. Все это, здесь и сейчас - это наш шанс. Что с ним делать - решать вам и только вам. Но я знаю одно - я не упущу свой шанс даже за все золото мира! Я сделал свой выбор, теперь ваш черёд!";
			link.l1 = "...";
			link.l1.go = "Exit";
		break;
...
//after pirate meeting
		...
		case "28":
			...
			link.l1 = "И верно! Предлагаю немедленно её найти и использовать по назначению!";
			link.l1.go = "Exit";
		break;
//exits
