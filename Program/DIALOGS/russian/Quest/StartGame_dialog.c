...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Node_3":
			dialog.text = "А, если не придёт, говорит, то всё, везите в приют для душевнобольных и даже не сумлевайтесь. Ибо не он это уже - раздвоение личное... А мы с Хопкинсом думаем - как же не он"+ GetSexPhrase("","а") +", ежели он"+ GetSexPhrase("","а") +"! Только, вроде, с похмелья сильного, и все браниться норовит, а язык заплетается, и речь на манер туземцев выходит. Почитай, полгода так с вами и пронянькались, в конце уже и понимать приноровились. Только оружие убрали от греха подальше, и доктор рому не велел давать...";
		...
		case "Advice_9":
			dialog.text = "Ещё можно поднять на корабле враждебный флаг, если он у вас есть, и уповать на свою удачу и скрытность. Ну, а самый надёжный способ благополучно проникнуть во вражеский город - купить лицензию национальной торговой компании, в этом случае вас никто не задержит. Однако, не забудь флаг на корабле поднять соответствующий. Сами понимаете, глупо пытаться предъявить испанскую лицензию, если флаг на мачте - английский.";
			link.l1     = "Дальше.";
		...
		case "Teach_battle_lose":
			...
			dialog.text = LinkRandPhrase("Да-а... Что-то совсем вы ослабели. Будьте внимательнее, больше блокируйте и парируйте. Пробивной не зевайте - от него блок не спасает, используйте финт, парирование или отскок.",
			                             "Не давайте себя ударить, перехватывайте удар противника колющим или парируйте. Но будьте осторожны, если попадётесь на финт - перехватят ваш колющий, да ещё и тебе нанесут.",
		...
		case "Alt_start2_2":
			dialog.text = "Минутку... Проверка... Вот дерьмо! Ошибся. Приятной игры, простите за неполадки! До свидания!";
