...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Uicilopochtli_fan_2":
			...
			link.l1 = "Кажется, ещё чуть-чуть и мои мозги таки перейдут в жидкое состояние... Ты можешь что-то с ним сделать?";
