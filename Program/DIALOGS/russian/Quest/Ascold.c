...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
 		...
 		case "AfterAttackMummy":
            ...
            if (GetCharacterIndex("LeifEricson") == -1)
            {
            	...
            	link.l1 = "Да все в порядке, мир спасён, люди могут спать спокойно.";
        		link.l1.go = "Step_60";
		...
		break;
 		...
 		case "Step_68":
        	dialog.text = "Ещё нужен странный предмет, идол древнего божества. Собираешь все три предмета - и ищешь человека, кто сможет провести обряд. Какая-нибудь ведьма местная вполне подойдет.";
