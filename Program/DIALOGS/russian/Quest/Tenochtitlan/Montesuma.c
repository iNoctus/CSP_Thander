...
void ProcessDialogEvent()
{
	...
	{
		case "First time":
			dialog.text = "О-о-о, ещё один белый пожаловал. "+ GetSexPhrase("","Да ещё и женщина. ") +"С чем ты приш"+ GetSexPhrase("ел","ла") +" к Теночтитлану?";
		...
		case "FT_1":
			...
			link.l1 = "Я знаю, что этот город - индейская столица. И что сам Кортес прошёлся здесь огнём и мечом.";
			link.l1.go = "FT_3";
		break;
		case "FT_3":
		...
		break;
		case "FT_6":
			dialog.text = "Наверное, ты понял"+ GetSexPhrase("","а") +", что сделать это не так просто. Дамба к городу надёжно защищена заклятием огня. Совсем недавно здесь было много белых людей. Все они сгорели...";
		...
		case "FT_7":
			...
			link.l1 = "Ладно, не будем об этом. Расскажи-ка мне лучше, что там в городе есть интересного? Там живёт кто-то, или нет? И ты что тут делаешь, на этом побережье?";
			link.l1.go = "FT_8";
		break;
		case "FT_8":
			dialog.text = "О-о, это долгая история. Приготовься слушать, "+ GetSexPhrase("белый капитан","прекрасная скво") +".\n"+
				...
				"Теперь в Теночтитлане хозяйничает бог царства мёртвых Миктлантекутли.";
		...
		case "FT_10":
			...
			link.l1 = "А почему ты не живёшь в Теночтитлане?";
			link.l1.go = "FT_11";
		break;
		case "FT_11":
		...
		case "FT_14":
			...
			link.l1 = "А может, пойдём со мной в город? Будешь махать своей дубиной, раскалывать черепа...";
			link.l1.go = "FT_15";
		break;
		case "FT_15":
		...
		break;
		case "FT_19":
			dialog.text = "Миктлантекутли, кто же ещё? Силой Камаштли, бога войны и судьбы, он наложил на дамбу заклятие огня. Ибо Камаштли является творцом огня.";
		...
		case "FTS_4":
			dialog.text = "Хорошо. Слушай внимательно, "+ GetSexPhrase("белый капитан","прекрасная скво") +".\n"+
				"Мои предки пришли на берега этого озера, называемого Тескоко, много веков назад. Тогда их звали мешики. Берега озера были заселены другими племенами, которые враждебно отнеслись к пришельцам. Но наш верховный бог, Уицилопочтли, повелел им остаться здесь. Тогда вождь мешиков Теноч принял решение остаться на берегах Тескоко, а мешики стали называться теночками.\n"+
				"Кошкоштли, вождь могущественного города Кулуакана, замыслил истребить теночков. Тогда мои предки покинули побережье и стали жить на заболоченном острове посреди озера. Прошло время, и теночки сумели укрепить остров и построить каменный город и даже дамбу к берегу. И когда теночки выбрали своим вождём Ицкоатля, была создана конфедерация племён, и народы конфедерации стали называться ацтеками.\n"+
				"Настали благословенные времена, ацтеки правили миром. Все племена платили ацтекам подати, поставляли еду, рабов и наложниц. Жертвенная кровь - пища наших богов - делала красным воды Тескоко. Знатных воинов приносили в жертву Тескатлипоке, покровителю жрецов, а в честь Камаштли обычных воинов сжигали. Женщины отдавали свою кровь богине Майяуэль, а дети - богу плодородия Тлалоку.\n"+
				"Так было больше ста лет. Но потом пришли испанцы и Теночтитлан попал в осаду. И пали наши герои во главе с Куаутемоком.\n"+
				"Теперь в Теночтитланом хозяйничает бог царства мёртвых Миктлантекутли.";
			link.l1 = "Так что, город необитаем?";
			link.l1.go = "FTS_5";
		break;
		case "FTS_5":
		...
		case "Fire":
			...
			{
				dialog.text = "Заклятие огня ещё не снято с дамбы.";
		...
		break;
		case "Fire_2":
			dialog.text = "Пять в пирамиде слева от храма Великой Жизненной Силы, пять - справа от него же. В малых пирамидах есть пять входов, каждый из которых ведёт в храм своего бога. Над каждым входом ты можешь увидеть изображение бога, которому и принадлежит данных храм. Смотреть лучше в полдень\nТебе нельзя ошибаться на входе, так как с каждым твоим посещением сила храмовой стражи будет расти.";
			link.l1 = "Там ещё и храмовая стража имеется?";
			link.l1.go = "Fire_3";
		break;
		case "Fire_3":
			dialog.text = "Да, воскрешённые Миктлантекутли ацтекские воины. Тебе придётся сражаться с ними. Внутрь храмов ты не сможешь взять помощников, так что все придётся делать только тебе.";
			link.l1 = "М-да, плохая новость... А что за 10 тотемов я долж"+ GetSexPhrase("ен","на") +" разыскать?";
			link.l1.go = "Fire_4";
		break;
		case "Fire_4":
			dialog.text = "Ты долж"+ GetSexPhrase("ен","на") +" найти следующие тотемы: Шочикецаль, богини цветов и любви\nМиктлантекутли, уже известного тебе бога мёртвых\nКецалькоатля, бога утренней звезды, владыки стихий\nМишкоатля, бога охоты\nТескатлипока, покровителя жрецов\nЧалчиуитликуэ, богини моря и озёр\nУицилопочтли, бога голубого ясного неба\nТлалока, бога грома и дождя\nМайяуэль, богини плодородия\nТонакатекутли, бога-созидателя, дарующего людям пищу.";
		...
		case "Fire_6":
			...
			link.l1 = "Понятно... Ну что же, тогда жди, когда я сумею раздобыть эти тотемы, проникнуть в храм и принести тебе череп. Боюсь, что ждать придётся долго.";
			link.l1.go = "Fire_7";
		break;
		case "Fire_7":
		...
		case "Totem":
			dialog.text = "У тебя нет нефритового черепа! Я жду, когда ты принесёшь его мне, "+ GetSexPhrase("белый капитан","прекрасная скво") +".";
		...
		//с собой нет черепа
		case "NotSkull":
			dialog.text = "Ты лжёшь, "+ GetSexPhrase("белый капитан","белая скво") +". За это Монтесума покарает тебя!";
			link.l1 = "Ну, попробуй...";
		...
		case "NotShootgun_3":
			...
			link.l1 = "Одного указания на то, что оружие лежит в каком-то храме, мне мало. И что я ещё могу получить ценного? Этот череп мне, знаешь ли, непросто достался...";
			link.l1.go = "Skull_1";
		break;
		...
		break;
		case "Skull_3":
			dialog.text = "С его помощью я верну свой народ к жизни. Теночтитлан снова обретёт могущество, и империя ацтеков покорит народы!";
			link.l1 = "Ваши боги отвернулись от ацтеков. А твоего народа больше нет.";
			link.l1.go = "Skull_4";
		break;
		case "Skull_4":
			dialog.text = "Я подниму свой народ из могил при помощи нефритового черепа! А богов мы найдём себе новых, задобрим их кровью рабов. Ацтеки вновь обретут силу, но теперь у нас будет и опыт. Ошибок прошлого я не повторю, и белые люди заплатят за своё коварство!";
		...
		case "Skull_6":
			...
			link.l1 = "У меня есть нефритовый череп, а он даёт власть над мёртвыми. Значит, и над тобой. Полагаю, что это все меняет.";
			link.l1.go = "Skull_7";
		break;
		case "Skull_7":
