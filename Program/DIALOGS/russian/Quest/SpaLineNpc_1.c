...
//********************************* Расследование убийства. Квест №4 **********************************
		...
		break;
 		case "Step_S4_6":
			dialog.text = "У-у-у, да вы весьма осведомлены об этом моем приключении, даже знаете, скольких испанских дьяволов я отправил на тот свет... Я впечатлён. Так кто же вы, судар"+ GetSexPhrase("ь","ыня") +"?";
