...
//>>>>>>>>>>>>========= Разброс диалогов по персонажам =====================
			...
			if (npchar.id == "Olone" && pchar.questTemp.State == "Fr5Olone_toGuadeloupe")// квест №6, базар в доме Олоне
            {
				dialog.text = NPCStringReactionRepeat("Судар"+ GetSexPhrase("ь","ыня") +", вас что, поучить хорошим манерам?! Ко мне в дом без приглашения не смеет входить никто!",
					         "Мы вроде бы все обсудили...", "Ещё что-то?", "Опять то же самое, сколько можно?!", "block", 0, npchar, Dialog.CurrentNode);
...
//********************************* Маркиз Бонрепо. Квест №8 **********************************
		...
		break;
 		case "Step_F8_9":
			...
			link.l1 = "Э-э... а... "+ GetSexPhrase("Баронский титул","Титул баронессы") +"? А как быть с тратами, которые я понёс"+ GetSexPhrase("","ла") +"?..";
