	...
	switch(Dialog.CurrentNode)
	{
		...
		//********************* Квест Асокльда *********************
   		case "Step_As_1":
			...
			link.l1 = "Ты не кипятись. Все дело в том, что я ищу три предмета индейского культа. Для покупки. Все одно - вы либо выбрасываете эту дрянь, либо продаёте за бесценок. Я готов"+ GetSexPhrase("","а") +" заплатить щедро за эти вещи, если они у вас есть.";
