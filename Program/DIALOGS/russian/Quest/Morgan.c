...
// ============================================================================
	switch(Dialog.CurrentNode)
	{
		...
		//********************* Английская линейка *********************
 		...
 		case "Step_1_4":
			dialog.text = "Мне кажется, я ясно выразился, что не могу провести сейчас данную операцию. Однако если вы найдёте меня несколько позже в моем доме на Ямайке, то, возможно, я смогу предложить лично вам горячее дело. Дело для настоящего корсара. А пока всего хорошего.";
