	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Step_2":
        	dialog.text = "Это ты о Лейфе Эриксоне? Не переживай, я не буду заставлять тебя разыскивать для себя предметы и штурмовать города.\n"+
       		...
       		link.l1 = "А как насчёт подмены тел? Этого ты тоже делать не будешь?";
    		link.l1.go = "Step_3";
		break;
		...
		case "Step_5":
        	dialog.text = "Да нет проблем. Я к тебе испытываю определённое чувство благодарности, ты ведь вскрыл"+ GetSexPhrase("","а") +" эту жестянку и не отдал"+ GetSexPhrase("","а") +" её церкви.\n"+
                          ...
                          "Лейф, к тому времени объездивший половину континента, ныне называемого Америкой, и побывавший в множестве местных племён, изучил довольно много сильных заклинаний. То есть стал добротным колдуном, в европейском понимании этого слова. Кстати, фокусу с переселением душ между двумя телами он научился у ацтеков.\n"+
                          ...
                          "А у тольтеков Лейф нашёл действенный ритуал вызова демонов. Он привёл ритуал в действие и, к несчастью, вызвал именно меня.";
		...
		case "Step_7":
        	dialog.text = "Точно. В такие жестянки помещают восточных демонов-рабов - джиннов. Лейф использовал лампу джинна для заточения меня.\n"+
                          ...
                          "Я, как всегда, провёл этот праздник чрезвычайно весело. Люблю, знаешь, земных девок подснимать, а готские ведьмы такие горячие-е-е-е.\n"+
                          "В общем, с похмелья даже и не увидел, куда лезу. Вот так и попался. А Лейф после моего заточения отправил письмо своим родственникам, где описал ритуал своего воскрешения. Это письмо и нашёл француз де ла Фонтен, а ты привёл"+ GetSexPhrase("","а") +" ритуал в действие.";
		...
		case "Step_10":
        	dialog.text = "Мне тоже. Учитывая то, что результатом знакомства стало моё освобождение, мне приятно вдвойне.\n"+
                          "Однако, теперь ты знаешь моё имя и можешь провести ритуал моего вызова. Надеюсь, ты не станешь дёргать меня по поводу и без повода.\n"+
                          "Я, знаешь ли, очень этого не люблю. Так попадёшь не в настроение, и моё хорошее отношение к тебе вмиг испарится. А в гневе я страшен...";
		...
		case "Step_12":
        	dialog.text = "Добро, зло... Две стороны одной медали.\n"+
                          "Зороастризм времён персидского царя Дария - первая религия в истории человечества, приблизившаяся к пониманию сути вещей, но и пророк Зороастр был весьма далёк от истины.\n"+
		...
		case "Step_13":
        	dialog.text = "Это сложно объяснить точно в человеческих формулировках, но давай рассмотрим пример.\n"+
                          "Предположим, ты вылечил"+ GetSexPhrase("","а") +" человека от тяжёлой болезни - это добрый поступок. Но твой добрый поступок является злым делом в отношении его несчастной падчерицы.\n"+
                          "Или, предположим, ты нанёс"+ GetSexPhrase("","ла") +" человеку увечье - это злое деяние. Но это злое деяние будет благом для той же падчерицы, страдающей от своего отчима-тирана.";
    		link.l1 = "Хм, вот оно как...";
    		link.l1.go = "Step_14";
		break;

		case "Step_14":
        	dialog.text = "В итоге силы зла и добра в своём противостоянии совершают поступки, которые сложно квалифицировать однозначно.\n"+
		...
		case "ToKillEnemy":
			dialog.text = NPCStringReactionRepeat("Убивать людей по твоему желанию? Совершенно неверный подход к пониманию сил Зла.",
                                           "Это твоё желание мы уже обсуждали.",
    	...
    	case "Step_17":
        	dialog.text = "Верно, точно так же, как и силы добра охотятся за этими же самыми душами.\n"+
                          "Убийство человека совершенно не означает, что его душа попадёт в Ад - это решает коллегия Страшного Суда. Задача тёмных сил состоит в том, чтобы обеспечить решение в нашу пользу.\n"+
                          "А это достигается не убийством человека, а потаканием его порокам. Его собственные поступки должны отдать нам его душу. Страсти в душе смертного должны из тлеющего уголька разгореться во всепожирающее пламя, а такой уголёк есть у каждого в душе...";
		...
		case "Step_18":
        	dialog.text = "Ах, это... К силам зла эти безумные толпы имеет весьма отдалённое отношение. Души некоторых умерших людей не попадают в канцелярию Старшного Суда, тому есть ряд причин.\n"+
                          "Есть у нас индейские демоны, выведены они в отдельный департамент, заправляет там ацтекский божок Миктлантехутль. Именно эта шайка заставляет душу, уже потерявшую после смерти сознание, управлять мёртвым телом, и не обязательно своим.\n"+
                          "Дело это затратное и хлопотное - заставить мёртвое тело двигаться, но, насколько мне известно, они нашли способ подвязать к этому делу элементалей стихий, производные от чистой природной энергии. Так что эти ходячие трупы по сути дела автономны.\n"+
						  "Зачем это нужно краснокожим - понятия не имею. Они у нас особняком держатся, их департамент отчёты предоставляет только высшему руководству. Странные они.\n"+
		...
		case "Step_19":
        	dialog.text = "Почему же, смогу. Хоть весь ближайший город пущу под нож, стоит тебе только пожелать. Только одно условие - за эту услугу я возьму твою бессмертную душу.\n"+
                          "А предварительно разорву и пожру твоё тело - я демон, а Контрольно-ревизионное Управление Ада строго следит за выполнением демонами своих служебных обязанностей.\n"+
                          "Соглас"+ GetSexPhrase("ен","на") +"?";
    		link.l1 = "Нет, слишком малая цена за мою душу. Да я вообще её продавать не собираюсь. Давай-ка лучше о других желаниях поговорим.";
    		link.l1.go = "Wishes";
		break;
		...
		case "Step_21":
        	dialog.text = "Деньгами я тебя обеспечу. Но дам тебе их не я.\n"+
                          "В городе Чарльстаун подойдёшь к ростовщику, его зовут " + GetFullName(characterFromId("Charles_usurer")) + ". Скажешь ему, что он должен тебе три миллиона и немедленно получишь все сумму целиком.";
		...
		case "Step_22":
        	dialog.text = "Ха-ха-ха! Каждый человек, ссужающий деньги под процент, уже продал нам душу.\n"+
                          ...
                          "Ну ладно, не будем отвлекаться. Ты довол"+ GetSexPhrase("ен","ьна") +"? Или твоя душа требует ещё исполнения желаний? Ха-ха!";
    		link.l1 = "Уф-ф-ф, хотелось бы ещё посмотреть на прейскурант.";
    		link.l1.go = "Wishes";
		break;
		...
		case "ToGovernor":
    		...
    		link.l1 = HeroStringReactionRepeat("Значит, я могу идти в свою резиденцию в Порт Рояле? И английский флот в Карибском море будет мне подчинён? И я смогу общаться с королём?", "Да, точно. Становил"+ GetSexPhrase("ся","ась") +" губернатором Ямайки...", "Даже не знаю, стоит ли?...", "Как прощай?!", npchar, Dialog.CurrentNode);
		...
		case "Step_27":
        	dialog.text = "Откуда мне знать, зачем тебе это? Ты захотел"+ GetSexPhrase("","а") +" быть губернатором - я тебя им сделал.\n"+
                          ...
                          "Мне придётся смоделировать целую цепь событий, которая привела тебя к креслу губернатора. Соответственно, события окружающего мира и людей вокруг тоже будут изменены. К чему это приведёт в итоге - не смогу точно сказать даже я.\n"+
		...
		case "Step_28":
    		...
    		link.l1 = "Нет, не хочу. Давай посмотрим, что ты ещё можешь мне предложить.";
    		link.l1.go = "Wishes";
		break;
		...
		case "Step_29":
        	dialog.text = "Это можно организовать. Только ты долж"+ GetSexPhrase("ен","на") +" понимать, что раны, нанесённые тебе в боях, приведут к разложению твоего тела.\n"+
		...
		case "Step_30":
        	dialog.text = "Теперь ясно. Только это не бессмертие, это неуязвимость. Можно организовать.\n"+
                          "Только здесь есть проблема - большие трудозатраты в плане реализации. Одно дело - привязать душу к телу навечно, это пустяк. А другое дело - хранить тело в неприкосновенности под градом пуль, это требует серьёзных затрат энергии.";
    		link.l1 = "Что?! Аззи, ты же демон, сверхъестественное существо. Ты можешь все, а рассказываешь мне о каких-то трудозатратах...";
    		link.l1.go = "Step_31";
		break;

		case "Step_31":
        	dialog.text = "А чего ты хотел"+ GetSexPhrase("","а") +"? Мы все живём по законам мироздания, просто вы законов этих не знаете.\n"+
		...
		case "Step_32":
        	dialog.text = "Итак, ты заключаешь контракт с Департаментом Ада по учёту людей. На основании этого контракта, ты долж"+ GetSexPhrase("ен","на") +" будешь обеспечивать данный адский Департамент необходимым количеством жизненной энергии, которую китайцы зовут ци.\n"+
                          "Также подойдёт и чистая природная энергия, которой питается вся эта нечисть в пещерах и катакомбах.";
		...
		case "Step_33":
        	dialog.text = "Ты долж"+ GetSexPhrase("ен","на") +" будешь делать то, чем и так занимаешься ежедневно - отправлять на тот свет людей и нечисть.\n"+
                          "А адский Департамент автоматически зачисляет на твой баланс высвобожденную энергию, которая и идёт в обеспечение твоей неуязвимости.";
		...
		case "Step_34":
        	dialog.text = "Слушай, "+ GetSexPhrase("мон шер","дорогая") +", я тебе оказываю огромную услугу. Ты что думаешь, такие контракты с Департаментом Ада по учёту людей на дороге валяются?\n"+
		...
		case "Step_35":
    		...
    		link.l1.go = "Step_36";
    		link.l2 = "Нет, не соглас"+ GetSexPhrase("ен","на") +". Пусть все остаётся, как есть. Давай лучше посмотрим, что у тебя ещё есть в плане исполнения моих желаний.";
    		link.l2.go = "Wishes";
		break;

		case "Step_36":
        	dialog.text = "Кровью?! Хех, где ты начитал"+ GetSexPhrase("ся","ась") +" этих дешёвых мистических романов?\n"+
		...
		case "Step_37":
        	dialog.text = "Ну вот и все. Текст контракта занесён тебе в судовой журнал, ознакомься на досуге.\n"+
                          "Поздравляю тебя. Ты теперь совершенно неуязвим"+ GetSexPhrase("","а") +".";
    		link.l1 = "Это здорово! Слушай, я хочу посмотреть, что ты ещё можешь мне предложить в плане исполнения желаний.";
    		link.l1.go = "Wishes";
		...
		case "Step_39":
        	dialog.text = "Ничего. Это я делаю за счёт собственных ресурсов, не привлекаю никого дополнительно.";
    		link.l1 = "Это хорошо. Ну что ж, давай посмотрим, что у тебя ещё интересного в плане исполнения желаний?";
    		link.l1.go = "Wishes";
		break;
		...
		case "Step_40":
        	dialog.text = "Ясно. В общем, на Тортуге есть бордель, содержит его некая Маргарита. Эта женщина - ведьма, она может сделать то, что тебе нужно. За то время, что ты к ней доберёшься, я с ней договорюсь.";
    		link.l1 = "Хорошо, зайду к ней, спасибо тебе. А что ещё можно у тебя пожелать?";
    		link.l1.go = "Wishes";
		...
		case "Step_43":
    		...
    		link.l1 = "Уважаемый Аззи, спасибо за совет, я обязательно им воспользуюсь. А сейчас могу я услышать ещё что-нибудь об исполнении желаний?";
    		link.l1.go = "Wishes";
            if (CheckAttribute(pchar, "questTemp.Azzy.Immortal"))
		    {
        		...
        		link.l1 = "Аззи, это же просто здорово! Я могу услышать ещё что-нибудь об исполнении желаний?";
		    }
		break;

		case "ToEnd":
        	dialog.text = "Ты меня изрядно утомил"+ GetSexPhrase("","а") +", зато я проверил своё терпение. И пусть теперь не говорят ангелы, что демоны - дикие и необузданные существа.\n"+
                          "Мне было приятно с тобой разговаривать. Если ты когда-нибудь осмелишься вызвать меня, то обещаю, что выслушаю тебя как минимум, а не пожру твоё тело немедленно. Ха-ха-ха.\n"+
		...
		case "Second time":
        	dialog.text = "Та-а-ак, опять я на вызовах... " + GetFullName(pchar) + ", ты же знаешь - я этого терпеть не могу. Сейчас тебе придётся очень постараться, дабы разъяснить причину.";
		...
		case "Step_48":
        	dialog.text = "Это верно. Ну что ж, давай прощаться, смертн"+ GetSexPhrase("ый","ая") +". Теперь уже навечно, поскольку ещё один вызов меня будет стоить тебе жизни.\n"+
		...
		break;
		case "ClimeUsurer_2":
			dialog.text = "Да и я, признаться, тоже. Ты меня забавляешь, смертн"+ GetSexPhrase("ый","ая") +". Все что-то тебе надо, все куда-то не в своё дело лезешь\nСейчас умудрил"+ GetSexPhrase("ся","ась") +" с индейскими демонами связаться. Угораздило же...";
			link.l1 = "Аззи, я и подумать не мог"+ GetSexPhrase("","ла") +", что дойдёт до такого! Кстати, а где это я, ты не в курсе?";
			link.l1.go = "ClimeUsurer_3";
		break;
		case "ClimeUsurer_3":
			dialog.text = "Ты в Теночтитлане, заброшенной столице ацтеков. Демона, что тебя забрал, зовут Миктлантекутли. Он тут из себя строит царя мёртвых ацтеков.";
