...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ELTHusb_SF_1":
			...
			link.l1 = "Все дело в том, что Максим Тейлор проведёт остаток своих дней в клетке на 'Тартарусе'. В качестве наказания адмирал дал ему пожизненное заключение.";
