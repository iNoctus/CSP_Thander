...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FS_1":
			dialog.text = "Нет, это далеко не так, к сожалению. Кораблей к нам пристаёт много, а вот живых людей там оказывается маловато. Не знаю, почему... И, кстати, я миссис.";
		...
		break;
		case "FT_2":
			dialog.text = "Кстати, если вы ещё не были у нашего главы, адмирала Чада Каппера, то вам лучше поторопиться. Иначе, он сам к вам придет.";
			link.l1 = "Хм, понятно.";
			link.l1.go = "exit";
		break;
		...
		case "SeekCitizen_agree":
			...
			if (npchar.quest.seekIdx.where == "none")
			{
				...
				{
					dialog.text = LinkRandPhrase("Понятия не имею, где она.", "Ни малейшего представления не имею, где он сейчас.", "Я не видела её уже довольно долго. Так что не могу знать.");
					link.l1 = RandPhraseSimple("Понятно.", "Ясно... Что же, спасибо.");
					link.l1.go = "exit";
				}
			}
			else
			{
				if (sld.sex == "man")
				{
					if (sld.location == "LostShipsCity_town")
					{
						...
						{
							dialog.text = LinkRandPhrase("Он здесь, на этом корабле. Смотрите внимательней, пожалуйста.", "Хм, так ведь он сейчас на этом корабле...", "Он на этом корабле, странно, что вы ещё не встретились.");
						}
						else
						{
				...
				else
				{
					if (sld.location == "LostShipsCity_town")
					{
						...
						{
							dialog.text = LinkRandPhrase("Она здесь, на этом корабле. Смотрите внимательней, пожалуйста.", "Хм, так ведь она сейчас на этом корабле...", "Она на этом корабле, странно, что вы ещё не встретились.");
						}
						else
						{
		...
		break;
		case "ansewer_2_1":
			dialog.text = "Имеются, но я не считала. Вы знаете, здесь совершенно все равно, какой вы нации. Это ровным счётом ни о чем не говорит и ни на что не влияет.";
			link.l1 = "Понятно...";
			link.l1.go = "int_quests";
		break;
		case "ansewer_2":
		...
		break;
		case "SeekGoods_1":
			dialog.text = "Ну, провианта и лекарств у меня нет. А вот ядер на корабле осталось довольно много ещё с тех времён, когда он ходил под парусом. А сколько вам нужно?";
		...
		case "SeekCrew":
			...
			link.l1 ="Вы ничего мне не должны. Но если вы не уйдёте сейчас со мной, то наверняка погибнете. Дело в том, что надвигающийся шторм разрушит Город.";
		...
		break;
		case "SeekCrew_2":
			dialog.text = "Ох, я верю Ведекеру, видимо, так и произойдёт\nНу что же, я согласна.";
		...
		case "ELTHusb_good":
			...
			link.l1 = "Ну, я кое-что выяснил"+ GetSexPhrase("","а") +" и рассказал"+ GetSexPhrase("","а") +" об этом адмиралу. Чад согласился дать вашему мужу ещё один шанс остепениться.";
		...
		break;
		case "ELTHusb_good_2":
			dialog.text = "Вы сдержали своё слово, а я сдержу своё. Извольте получить ключ.";
