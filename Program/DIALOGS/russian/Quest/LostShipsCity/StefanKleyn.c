	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "О, "+ GetSexPhrase("новый капитан","девушка") +"! Кажется, именно ты "+ GetSexPhrase("пришёл последним","пришла последней") +".";
		...
		case "int_quests":
			...
			{
				link.l4 = "Приятель, ты давно уже живёшь на этом острове?";
		...
		case "SeekCrew_1":
			...
			link.l1 = "Если не уйдёшь со мной, то погибнешь. Грядущий шторм наверняка разрушит Город.";
