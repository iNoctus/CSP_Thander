...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_4":
			dialog.text = "Нет, что вы, очень редко. Вы знаете, когда у нас штормит, то многие мужчины чуть ли не пачкают панталоны, а мне все нипочём. Штормов я не боюсь!";
		...
		break;
		case "ansewer_1":
			dialog.text = "Этот остров называется Городом Потерянных Кораблей. Все мы оторваны от окружающего мира и живём без надежды вырваться из этой клетки...";
		...
		break;
		case "ansewer_1_1":
			dialog.text = "С этой стороны, канечно, так оно и есть. Но если бы вы знали, как все это надоело! Ничего нового, только крушения и смерть вокруг нас. Живём в кольце несчастий, как это тягостно!..";
			link.l1 = "Ну, это да...";
			link.l1.go = "int_quests";
		break;
		case "ansewer_2":
			dialog.text = "Я думаю, для начала вам стоит заглянуть в таверну. Есть церковь и магазин... Кстати, если вы ещё не были у адмирала, то сначала вам стоит отправиться именно туда!";
			link.l1 = "Хорошо, я так и сделаю. Спасибо.";
			link.l1.go = "int_quests";
			NextDiag.(NodePrevName).l2 = true;
		break;
		case "ansewer_3":
			dialog.text = "Чад Каппер - серьёзный мужчина. Говорят, в прошлой жизни он был капитаном пиратов! Три года назад он попал сюда и сразу прибрал власть к рукам. С тех пор он - бессменный адмирал Города.";
			link.l1 = "Понятно...";
			link.l1.go = "int_quests";
		...
		break;
		case "SeekCrew_1":
			dialog.text = "Вы нарушили Закон, и ведёте себя так, как будто все нормально.";
		...
		break;
		case "TakeMap_2":
			dialog.text = "Ну, это в порядке вещей. Если у вас есть что продать, вы вправе выставлять любую цену на товар. И Эрик также в своём праве.";
