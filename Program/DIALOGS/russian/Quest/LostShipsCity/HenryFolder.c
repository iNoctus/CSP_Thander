...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FT_7":
			dialog.text = "Слух прошёл, капитан. Я первым сообразил, что это не просто пьяная байка, и решил отправиться сюда. Я нанял капитана с командой, собрал все сведения, обзавёлся сомнительной картой... но все получилось куда проще.\n"+
		...
		break;
		case "FT_9":
			dialog.text = "Кому как, но я бы предпочёл бурю, а не глупое крушение.";
		...
		break;
		case "ansewer_1_1":
			dialog.text = "Конечно, нет. Никто о нем ничего не знает на Большой земле. Слухи разве что ходят у нищих об Острове Справедливости... Но кто это серьёзно воспримет?";
			link.l1 = "Это точно.";
			link.l1.go = "int_quests";
		break;
		case "ansewer_2":
		...
		break;
		case "ansewer_2_1":
			dialog.text = "Здесь нет сундуков без ключей, "+ GetSexPhrase("приятель","" + pchar.name + "") +". Все открывается только ключами. И учти, что кроме тебя ещё куча народу, у кого такие ключи имеются. Если хочешь что-нибудь надёжно спрятать, то нужно искать сундук где-нибудь за Городом, куда плыть нужно...";
			link.l1 = "Ага, понятно...";
			link.l1.go = "int_quests";
		break;
		case "ansewer_3":
		...
		case "ansewer_5_1":
			...
			link.l1 = "Ха, да ты старожил! Наверное, ещё раньше покойного Хилла Брюннера стал гражданином Города.";
			link.l1.go = "ansewer_5_2";
		break;
		case "ansewer_5_2":
			dialog.text = "Нет, не раньше.";
			link.l1 = "Понятно... Слушай, а ты не знаешь ещё кого-нибудь из старых жителей города?";
