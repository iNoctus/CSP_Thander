...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FS_1":
			dialog.text = "Да нет, что ты, завтра к вечеру уже все устаканится. Кстати, если ты ещё не был"+ GetSexPhrase("","а") +" у адмирала, то советую поторопиться. Он находится на варшипе 'Сан Августин'. До конца шторма тебе надо к нему попасть.";
			link.l1 = "Хорошо, я понял"+ GetSexPhrase("","а") +".";
			link.l1.go = "exit";
		break;
		case "FT_1":
			dialog.text = "Если ты ещё не был"+ GetSexPhrase("","а") +" у адмирала, то советую поторопиться. Он находится на варшипе 'Сан Августин'.";
			link.l1 = "Хорошо, я понял"+ GetSexPhrase("","а") +".";
			link.l1.go = "exit";
		break;
		...
		break;
		case "ansewer_2_4":
			dialog.text = "Понимаю, но придётся. А не сумеешь обтесаться здесь - с ума сойдёшь. И тогда тебе конец по Закону!";
			link.l1 = "Чего?!";
