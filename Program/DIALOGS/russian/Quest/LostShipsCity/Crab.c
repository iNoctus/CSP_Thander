...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			{
				dialog.text = "(Перед вами детёныш чудовищ-переростков, истреблением которых вы занимались последние несколько часов. Быть может, вам это только кажется, но глядя на краба вы чувствуете его скорбь.)";
			...
			else
			{
				...
				{
					dialog.text = "(Краб смотрит на вас, словно ждёт чего-то.)";
				...
				{
					dialog.text = "(Краб щёлкает клешней в знак приветствия.)";
		...
		case "crab_meat_1":
			dialog.text = "(Краб одобрительно щёлкает клешней, предвкушая своё угощение.)";
		...
		break;
		case "crab_hire_1":
			dialog.text = "(Краб издаёт серию щёлкающих звуков)";
			link.l1 = "Вот черт. Я тебя не понимаю, но надеюсь что ты меня сможешь. Ты вроде смышлёный и не такой злой, как твои сородичи. Не хочешь сбежать отсюда вместе со мной?";
			link.l1.go = "crab_hire_2";
		break;
		case "crab_hire_2":
			dialog.text = "(Существо издаёт звук, который вы воспринимаете как согласие)";
