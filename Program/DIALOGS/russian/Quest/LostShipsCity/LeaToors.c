...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ansewer_2":
			...
			link.l1 = "Понятно... Скажите, а вы не знаете кого-нибудь из местных старожилов, кто уже очень долго здесь живёт?";
		...
		break;
		case "SeekGoods_2":
			dialog.text = "Хорошо, я отдам её вам. Только сначала принесите мне 10 мешочков соли.";
			link.l1 = "Чего?";
		...
		case "TakeGrapes":
			...
			{
				link.l1 = "Нет ещё, не могу найти. Может, как-нибудь по-другому договоримся?";
		...
		case "TakeGrapes_yes":
			...
			link.l1 = "Спасибо. Эх, как бы доставить её на 'Сан Габриэль'?..";
		...
		break;
		case "LostDecster_2":
			dialog.text = "Если вы хотите вступить в противоборство с адмиралом, то, боюсь, вас ждёт судьба несчастного Лейтона.";
		...
		break;
		case "LostDecster_5":
			dialog.text = "Но потом меж ними пробежала чёрная кошка. Как-то я ходила навещать Максима Тейлора, который очередной раз угодил за решётку. А дело было к вечеру, и, в общем, я там задержалась до полуночи\nИ вот, когда я вышла на палубу, то услышала два голоса - Чада и Лейтона. Они спорили о деньгах...";
