...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FS_1":
			dialog.text = "Что вы, это ещё куда ни шло! Вам вообще крупно повезло, вы ведь разбились уже в конце бури, когда сила стихии пошла на убыль. Чуть раньше, и вы бы не сумели выбраться к нам...";
			link.l1 = "Жаль людей, корабль... Грустно, в общем.";
			link.l1.go = "FT_2";
		break;
		case "FT_1":
			dialog.text = "Очень рад познакомиться с вами. Как вам наш Город на первый взгляд?";
			link.l1 = "Не успел"+ GetSexPhrase("","а") +" ещё освоиться в полной мере.";
			link.l1.go = "FT_2";
		break;
		case "FT_2":
		...
		case "ansewer_2_1":
			...
			link.l1 = "Это понятно. А что там насчёт выборов адмирала?";
		...
		case "SeekCrew_1":
			...
			link.l1 = "Да, у меня есть судно, подготовленное к отплытию.";
