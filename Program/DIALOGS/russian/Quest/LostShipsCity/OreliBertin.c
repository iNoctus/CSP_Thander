...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SessilDead":
			dialog.text = "Сесил была старейшим жителем Города... Вы знаете, почему её убили?";
		...
		break;
		case "SessilDead_3":
			dialog.text = "Имя Механика - Хенрик Ведекер. Большинство граждан Города даже не знают, что он живёт с нами. С тех пор, как клан 'Каспер' обосновался на барке 'Сан Габриэль', Механика я не видела.";
		...
		case "SessilDead_5":
			...
			link.l1 = "А вы уверены, что Хенрик ещё жив?";
			link.l1.go = "SessilDead_6";
		break;
		case "SessilDead_6":
			dialog.text = "Уверена. Дело в том, Хенрик изобрёл способ крепления кораблей в острове, он нужен адмиралу. Иначе Город Потерянных Кораблей некому будет чинить.";
		...
		break;
		case "SeekCrew_1":
			dialog.text = "И он в хорошем состоянии? Мы доплывём до Большой земли?";
			link.l1 = "Непременно.";
