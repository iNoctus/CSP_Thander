...
void ProcessDialogEvent()
{
	...
	case "CitizenNotBlade":
		...
		case "Tavern_5":
			dialog.text = "Время идёт, да и я старею. Не так просто мне уже отправить человека на тот свет...  А Сальватор, говорят, на мои денежки свадебку сыграл. Живёт теперь в Сан-Хуане...";
			link.l1 = "Черт меня побери!  Атилла, дружище, а не навестить ли мне это тихое семейное гнёздышко? Глядишь, в жениной шкатулке твои побрякушки отыщутся, а?";
			link.l1.go = "Tavern_6";
		break;

		case "Tavern_6":
			dialog.text = "Ха-ха-ха! Сдаётся мне, ты не ради побрякушек в её спальню пробраться надумал!  Да нет, приятель, раз уплыла добыча из моих рук - видно, так тому и быть... Ну, пора мне. Даст Бог - ещё свидимся.";
		...
		case "TalkingNews_5":
			...
			link.l1 = "В общем, прибыл я на Сан-Хуан после разговора с тобой и начал выяснять, что к чему. Много чего там случилось, но в итоге оказалось, что Сальватор обокрал свою жену и у меня на глазах убил её брата.";
			link.l1.go = "TalkingNews_6";
		break;
		case "TalkingNews_6":
			dialog.text = "Да уж, разошёлся, мерзавец...";
		...
		case "TalkingNews_7":
			...
			link.l1 = "Думаю найти Сальватора и выпустить ему кишки. Ещё с Изабеллой нужно объясниться... Она думает, что это я убил её брата.";
		...
		break;
		case "TalkingNews_12":
			dialog.text = "Думаю, да. Не ты один с уважением относишься к Атилле, есть и ещё у этого пирата друзья...";
		...
		case "AtillaInHouse_3":
			dialog.text = "Известно, приятель. Похоже, что Сальватор выманил её из Сан-Хуана. Он прислал за ней пиратский бриг 'Восторженный' и, по слухам, кэп взял курс на Порто Белло.";
			link.l1 = "И зачем она ему? Он уже разорил ее...";
			link.l1.go = "AtillaInHouse_4";
		break;
		case "AtillaInHouse_4":
			dialog.text = "Полагаю, чтобы спрятать концы в воду, приятель. Не жить твоей Изабелле, если она попадёт в руки Сальватора.";
			link.l1 = "Аргх, когда бриг вышел из Сан-Хуана? Я должен успеть перехватить его!";
			link.l1.go = "AtillaInHouse_5";
		break;
		case "AtillaInHouse_5":
			dialog.text = "Если хочешь увидеть Изабеллу живой - то да. Бриг вышел из Сан-Хуана три дня тому назад. По моим расчётам, он будет у Порто Белло дней через пятнадцать-шестнадцать, не более.";
			link.l1 = "Значит, мне надо торопится... Спасибо тебе, Атилла!";
			link.l1.go = "AtillaInHouse_6";
		break;
		case "AtillaInHouse_6":
			dialog.text = "Приятель, ты не забудь ма-а-аленкую деталь - где-то в Порто Белло должен находиться и сам Сальватор. Он ждёт там Изабеллу.";
		...
		case "Brig_Sunk":
			dialog.text = "Ну, рассказывай, как у тебя дела?";
			link.l1 = "Дела неважно... У Порто Белло нагнал я бриг, но взять его на абордаж не сумел - тот пошёл ко дну во время боя. Никто не выжил...";
		...
		case "Isabella_Sink_1":
			...
			link.l1 = "Была, вот только не поверила она мне. И забрать её с тонущего корабля не смог, она предпочла пойти ко дну вместе с бригом. Вот так, Атилла...";
			link.l1.go = "Brig_Late_2";
		break;
		...
		case "SalvatorNews_5":
			...
			link.l1 = "Дьявол! Я же отвёз в Белиз Изабеллу!!!";
			link.l1.go = "SalvatorNews_6";
		break;
		case "SalvatorNews_6":
			dialog.text = "А-а-а, ну теперь понятно, что ему там понадобилось. Я бы на твоём месте времени даром не терял...";
		...
		case "IsabellaIsDead_1":
			...
			link.l1 = "Я убил Сальватора и мы должны были обвенчаться с Изабеллой в Сан-Хуане. На церемонии в церковь воралась толпа головорезов, и они убили ее... Их нанял Сальватор, когда был ещё жив.";
		...
		break;
		case "AddRepa_1":
			dialog.text = "Удивил, " + pchar.name + "... Ну что же, спасибо и на этом. Дарёному коню, как извесно, в зубы не глядят...";
