...
// ============================================================================
	switch(Dialog.CurrentNode)
	{
		...
		case "BrigAbordage_2":
			...
			{
				link.l1 = "Мне не к чему оправдываться, ибо я сам видел, как Сальватор зарезал вашего брата. Ваш брат выяснил, что именно Сальватор подделал векселя, убившие вашего отца. Дон Мигель собирался доложить об этом губернатору и тогда Сальватор убил его. Он пытался убить и меня, чтобы сокрыть своё преступление. Вы все равно бы мне не поверили, и я решил покинуть город на время.";
		...
		case "NewLife_firstTime":
			...
			if (sti(rColony.HeroOwn))
			{
				dialog.text = "Ах, дорогой, как хорошо, что ты наконец-то пришёл домой! Все в порядке?";
				link.l1 = "Да, дорогая, все нормально...";
			}
			else
			{
				dialog.text = "Ах, дорогой, как хорошо, что ты наконец-то пришёл домой! Уладил все вопросы с происшествием в церкви?";
				link.l1 = "Да, дорогая, я был на приёме у губернатора. Все в порядке - он нас поздравляет.";
			}
...
//************************************ новая жизнь бывшего корсара ********************************
		...
		case "NewLife_Budget":
			...
			else //профицит
			{
				...
				link.l1.go = "NewLife";
				link.l2 = "Хочу ещё оставить тебе денег, чтобы ты ни в чем не нуждалась.";
				link.l2.go = "NewLife_Budget_Add";
			}
		break;
		...
		case "NewLife_Budget_Pay":
			...
			{
				link.l1 = HeroStringReactionRepeat("Хорошо, дорогая, я готов погасить задолженность.", "И я их нашёл, Изабелла! Я готов рассчитаться с долгами!", "Изабелла, дорогая, я все прекрасно помню. Я нашёл деньги и готов закрыть долги.", "Изабелла, как раз сейчас...", npchar, Dialog.CurrentNode);
