...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
            ...
            {
            	dialog.text = "Ну вот, теперь все в порядке. Ты готов"+ GetSexPhrase("","а") +" выполнить своё предназначение?";
            ...
            if (pchar.questTemp.Ascold == "Ascold_MummyFoundItems")
            {
                ...
                {
                	link.l1 = "Они у меня. Забирай и отдай мне моё тело!";
            		link.l1.go = "Step_29";
                }
                else
                {
        ...
        case "Step_13":
        	dialog.text = "Какой замысел? Ха-ха-ха.... Ты здесь и разговариваешь со мной, с человеком, умершим более шести столетий назад!\n"+
                          "В этом и заключается мой замысел. Значит, моё послание потомкам было найдено...";
    		link.l1 = "Что... Кто ты?";
    		link.l1.go = "Step_14";
		break;
        ...
        case "Step_17":
        	dialog.text = "Америкой ты называешь эти большие земли? Ха-ха-ха. Слушай меня, "+ GetSexPhrase("свободный корсар","женщина-воин") +".\n"+
                          "Летом 986 года от РХ норвежский викинг Бьярни Херьюльфсон, направлявшийся в Гренландию, был отнесён к новой неведомой земле, но не пристал к ней.\n"+
                          "В 1000 году я, Лейф Эриксон, отправился на поиски этой земли. Я нашёл остров Хеллюланд (Баффинова земля), затем Маркланд (Лабрадор) и Винланд (Ньюфаундленд). На Винланде я основал поселение.\n"+
                          "Через два года я отправился дальше и нашёл эту большую землю. Я пристал к ней гораздо северней.";
    		link.l1 = "Не может быть! Так Америка была открыта ещё шесть столетий назад...";
    		link.l1.go = "Step_18";
		break;

        case "Step_18":
        	dialog.text = "Эта земля была открыта мной в 1002 году.\n"+
                          "Затем я пошёл вглубь земли и увидел, что земля эта бесконечна и заселена краснокожими людьми.";
    		link.l1 = "Индейцы...";
    		link.l1.go = "Step_19";
		break;
        ...
        case "Step_20":
        	dialog.text = "Не торопись, сначала я сделаю тебе бесценный подарок за своё освобождение.";
    		link.l1 = "О-о-о, это дело я люблю. И что это за подарок?";
    		link.l1.go = "Step_21";
		break;

        case "Step_21":
        	dialog.text = "Твоя жизнь. Я дарю её тебе в качестве благодарности.";
    		link.l1 = "Здорово... Ну, я пош"+ GetSexPhrase("ел","ла") +"?";
    		link.l1.go = "Step_22";
		break;
        ...
        case "Step_23":
        	dialog.text = "Я чувствую, что здесь рядом стоит большой город. Там, у самого главного человека в городе, находятся нужные мне вещи, я ощущаю их присутствие.\n"+
                          "Ты долж"+ GetSexPhrase("ен","на") +" доставить мне три хрустальных черепа тольтеков - белый, розовый и голубой, а также древний предмет, именуемый странной вещью. Тогда я стану сильней и смогу восстановить своё тело. Мир ждёт своего властителя...";
        ...
        case "Step_24":
        	dialog.text = "В общем, да. Только ещё одно ма-а-аленькое дельце, для того, чтобы ты побыстрей возвращал"+ GetSexPhrase("ся","ась") +".\n"+
                          "На время я беру твоё тело, а тебе даю своё. Тоже на время.";
    		link.l1 = "Что?!!!";
        ...
        case "Step_27":
        	dialog.text = "За это не волнуйся, я тебе его верну в целости. Твоё тело мне не нужно, оно мне не нравится.\n"+
                          "Все, ты можешь идти.";
