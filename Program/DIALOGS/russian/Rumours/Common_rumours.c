...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	case "rumours_habitue":
		...
		if (pchar.questTemp.Slavetrader == "FindRatJamaica_H" && npchar.location == "FortOrange_tavern")
        {
            ...
            link.l1 = "Да в море все так же, как и всегда - сыро и солоно. Ты вот скажи лучше, не знаешь ли, куда ушёл мой приятель, который тут комнату снимал недавно? Франсуа Гонтьер его зовут.";
		...
		break;
 		case "AscoldTrader_2":
        	dialog.text = "Полагаю, ты не останешься в накладе. Слушай внимательно.\n"+
                          "На Гваделупе в городе Бас Тёр живёт один странный тип - Аскольд.";
...
string sRumourAboutOwners_Init(string sOwnerType, int iRumourNum) // База слухов жителей. Можно менять без новой игры
{
	...
	STR_TRADER[1] = "Он главный поставщик нашего губернатора, и это даёт ему неплохой доход. Но дела он свои ведёт честно. Ну, или пока ни в чем позорящем его замечен не был.";
