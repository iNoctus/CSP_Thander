		...
		case "work_1":  // работа на благо короны - линейка нации
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                    ...
                    else
                    {
						switch(pchar.questTemp.CurQuestNumber)   // Взятие квестов начиная со второго
                        {
                            ...
                            case "8":
								...
								link.l1 = "Благодарю за доверие. Но в чем заключается моё задание?";
                                link.l1.go = "Step_8_1";
                            break;
                            case "9":
                ...
                case "Fr1Legran_backGovernor":
                    dialog.text = "Месье Легран сумел мне сообщить, что с ним все в порядке. Кстати, он очень лестно о вас отозвался. Я рад, что не ошибся в выборе честного и надёжного человека.";
