...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
        ...
        break;
        case "Step_4_2":
            dialog.text = "Черт возьми! Мы не смогли защитить граждан Республики Соединённых Провинций от кровожадных англичан. Это очень плохо, наше и без того скромное присутствие в Карибском регионе теперь совершенно ослаблено.";
