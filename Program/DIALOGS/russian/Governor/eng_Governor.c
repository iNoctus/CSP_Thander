...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
        ...
        case "Step_4_4":
            dialog.text = "То, что вы побывали в голландской тюрьме, меня волнует мало. Мне нужна информация, а у вас её нет. Я разочарован. Вы можете появиться здесь позже, когда мне удастся все-таки получить нужную информацию.";
            link.l1 = "Конечно, сэр. Извините, что не "+ GetSexPhrase("смог","смогла") +" помочь вам.";
            link.l1.go = "exit";
            CloseQuestHeader("Eng_Line_4_Intelligence_Curacao");
            pchar.questTemp.State = "empty";
        ...
        case "Step_9_4":
            dialog.text = "Черт возьми, вы действительно незаменимый человек, " + pchar.name + ". Мэнсфилд отомщён на славу!";
