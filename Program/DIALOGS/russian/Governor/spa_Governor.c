...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
        ...
        break;
        case "Step_6_3":
            dialog.text = "И ещё один момент. Я вручаю вам лицензию Французской Вест-Индской компании сроком на 60 дней. Вы должны предъявить эту бумагу начальнику порта и вас никто ни в чем не заподозрит.\n"+
...
//********************** Квест №9, Четыре золотых галеона. ************************
        ...
        break;
		case "Step_9_8":
            dialog.text = "Черт возьми!!! Как же такое могло случиться?! Я понимаю, что вы оказались в тяжелейшей ситуации, но вы могли бы быть более расторопн"+ GetSexPhrase("ым","ой") +". А сейчас мне нужно отчитываться в Мадриде за серьёзную недостачу в поставках золота... И это тогда, когда Испания ведёт изнурительную борьбу в Европе!";
