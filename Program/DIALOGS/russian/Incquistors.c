	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (findsubstr(npchar.id, "Prisoner", 0) != -1) //заключённые
			{
				...
				{
					dialog.text = LinkRandPhrase("Нет ничего людского у этих 'святош'. Попомни моё слово - гореть им в аду за наши муки...", "Ежедневные истязания и пытки! А ведь я же ни в чем не виноват перед Господом!!!", "Вчера умер мой сосед по камере, они два дня пытали его на дыбе... А сколько мне осталось?..");
...
//**************************** сдаём зачарованный Дес-Мойнес ********************************
		...
		break;
		case "MCIncq_2":
			dialog.text = "Ага... Мы займёмся этим, "+ GetSexPhrase("сын мой","дочь моя") +". Господь благодарит тебя за верную службу церкви.";
