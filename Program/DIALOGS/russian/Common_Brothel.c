...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "SpeakHistoryTwo_10":
			dialog.text = "Да? И о чем же ещё? Даже боюсь предположить.";
        ...
        case "Horse_AfterSex_2":
			...
			{
				dialog.text = LinkRandPhrase("Заходи к нам ещё как-нибудь...", "До свидания и до новых встреч...", "Будем рады видеть тебя у нас еще...");
				Link.l1 = "Ладно...";
				Link.l1.go = "exit";
				NextDiag.TempNode = "Horse_AfterSex_2";
			}
