...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "PoorHeadMan_1":
			dialog.text = "Ну что же, это хорошо. Насколько я смог понять, ты пытаешься узнать о людях, которым мы здорово досадили. Причём настолько сильно, что они готовы нас убивать. Все правильно?";
