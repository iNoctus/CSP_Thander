...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		break;
 		...
 		case "Step_Az12":
        	dialog.text = "А вот этого я бы делать не стал. Мой помощник полюбопытствовал уже, спрятался днём в сарае, подсмотреть хотел. Только утром нашли его рядом с ромом тронутым, теперь сидит целыми днями, слюни пускает и мычит.\n"+
