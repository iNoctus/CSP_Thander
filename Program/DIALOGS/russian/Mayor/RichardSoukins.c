...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "pirateStartQuest_2":
			dialog.text = "Нет, конечно. Разве я похож на идиота? Задаток я не верну в любом случае. Но мне нужны доказательства, что рабы, которых ему подсовывают - это и есть моя партия. А ты просто найдёшь тех, кто предложил ему новую сделку, и получишь свои 10 000 пиастров. Остальное моя забота. Ну что, берёшься?";
		...
		case "pirateStartQuest_3":
			dialog.text = "Если бы у меня был хоть намёк, я обошёлся бы и без твоих услуг. Они бы уже к ночи ловили кальмаров на живца. Но меня больше интересует другое - как они узнали о грузе 'Сентблу' и о моем заказчике? Уж очень все быстро у них срослось. Смекаешь?";
		...
		case "pirateStartQuest_final":
			dialog.text = "Знаем-знаем. Мои люди наблюдали бой и уже доложили мне, как ты здорово управил"+ GetSexPhrase("ся","ась") +". Ну что ж, дело своё ты исправно сделал"+ GetSexPhrase("","а") +", вот обещанная награда в 15 000 пиастров. И спасибо тебе, здорово ты мне помог"+ GetSexPhrase("","ла") +".";
		...
		case "PL_Q8_deck_2":
			dialog.text = "Ну и что ты опять делаешь у меня на палубе? Думаешь, если ты удачно провёл"+ GetSexPhrase("","а") +" штурм Порто Белло, то теперь можно пав"+ GetSexPhrase("лином","ой") +" тут разгуливать?";
